...
/**
 ** \file parser.h
 ** Define the tensorglue::parser::parser class.
 */
  ...
  private:
        ...
        switch (this->kind ())
    {
      ...
      case symbol_kind::S_identifier: // identifier
        value.move< TNode* > (std::move (that.value));
        break;
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, TNode*&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const TNode*& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
switch (yykind)
    ...
    struct symbol_type : basic_symbol<by_kind>
    {
      ...
      {
#if !defined _MSC_VER || defined __clang__
        YY_ASSERT ((token::TOKEN_IDENTIFIER <= tok && tok <= token::TOKEN_IF));
#endif
      }
    };

    /// Build a parser object.
    Parser (tensorglue::parser::Scanner& scanner_yyarg, tensorglue::parser::Driver& driver_yyarg);
    virtual ~Parser ();
    ...
    // Implementation of make_symbol for each token kind.
      ...
      {
        return symbol_type (token::TOKEN_CEQ, std::move (l));
      }
#else
      static
      symbol_type
      ...
      {
        return symbol_type (token::TOKEN_CEQ, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_CNE (location_type l)
      {
        return symbol_type (token::TOKEN_CNE, std::move (l));
      }
#else
      static
      symbol_type
      make_CNE (const location_type& l)
      {
        return symbol_type (token::TOKEN_CNE, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      {
        return symbol_type (token::TOKEN_CLT, std::move (l));
      }
#else
      static
      symbol_type
      ...
      {
        return symbol_type (token::TOKEN_CLT, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_CLE (location_type l)
      {
        return symbol_type (token::TOKEN_CLE, std::move (l));
      }
#else
      static
      symbol_type
      make_CLE (const location_type& l)
      {
        return symbol_type (token::TOKEN_CLE, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      {
        return symbol_type (token::TOKEN_CGT, std::move (l));
      }
#else
      static
      symbol_type
      ...
      {
        return symbol_type (token::TOKEN_CGT, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_CGE (location_type l)
      {
        return symbol_type (token::TOKEN_CGE, std::move (l));
      }
#else
      static
      symbol_type
      make_CGE (const location_type& l)
      {
        return symbol_type (token::TOKEN_CGE, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      static
      symbol_type
      make_MATMUL (location_type l)
      {
        return symbol_type (token::TOKEN_MATMUL, std::move (l));
      }
#else
      static
      symbol_type
      make_MATMUL (const location_type& l)
      {
        return symbol_type (token::TOKEN_MATMUL, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      static
      symbol_type
      make_PLUS1 (const location_type& l)
      {
        return symbol_type (token::TOKEN_PLUS1, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_MINUS1 (location_type l)
      {
        return symbol_type (token::TOKEN_MINUS1, std::move (l));
      }
#else
      static
      symbol_type
      make_MINUS1 (const location_type& l)
      {
        return symbol_type (token::TOKEN_MINUS1, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
  ...
  private:
    ...
    // User arguments.
    tensorglue::parser::Scanner& scanner;
    tensorglue::parser::Driver& driver;
    ...
    , location (that.location)
  {
    switch (this->kind ())
    {
      ...
      case symbol_kind::S_if_expr: // if_expr
      case symbol_kind::S_identifier: // identifier
        value.copy< TNode* > (YY_MOVE (that.value));
        break;
  ...
  Parser::basic_symbol<Base>::move (basic_symbol& s)
  {
    ...
    switch (this->kind ())
    {
      ...
      case symbol_kind::S_if_expr: // if_expr
      case symbol_kind::S_identifier: // identifier
        value.move< TNode* > (YY_MOVE (s.value));
        break;
